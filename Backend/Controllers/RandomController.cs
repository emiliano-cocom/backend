...
namespace Backend.Controllers
{
    ...
    public class RandomController : ControllerBase
    {
        ...
        {
            /* EL SINGLETON DEVUELVE EL MISMO VALOR EN TODOS LAS PETICIONES Y CLIENTES
             * EL SCOPED DEVUELVE EL MISMO VALOR EN TODAS LAS PETICIONES DE UN MISMO CLIENTE
             * EL TRANSIENT DEVUELVE DIFERENTE VALOR EN CADA PETICION Y EN CADA CLIENTE
            */
